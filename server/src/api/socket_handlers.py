...
- agno agent and model providers (Google, Cohere, Mistral, OpenRouter)
...
def register_handlers(socket_manager):
    """
    Register all socket event handlers with the socket manager.
    
    Parameters:
        socket_manager: The SocketManager instance to register handlers with.
    """
